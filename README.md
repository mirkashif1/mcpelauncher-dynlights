...
A mod for mcpelauncher that adds zoom.
...
Download the mod from [releases](https://github.com/GameParrot/mcpelauncher-zoom/releases) and move the file into the `mods` directory.
